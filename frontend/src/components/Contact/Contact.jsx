...
import { FiMapPin, FiPhone, FiGlobe, FiMail, FiMessageSquare, FiArrowRight } from "react-icons/fi";
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x py-12 sm:py-16 md:py-20 px-4 lg:px-8 font-[poppins] relative overflow-hidden">
      <Toaster position="top-center" reverseOrder={false} toastOptions={{ duration: 400 }} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Address */}
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:scale-[1.02] animate-card-float border-2 border-amber-500 hover:border-amber-400 group">
              ...
              <div className="flex items-center mb-4 relative z-10">
                ...
                <h3 className="ml-4 text-amber-100 text-xl font-semibold">Our Address</h3>
              </div>
              <div className="pl-12 relative z-10">
                <p className="text-amber-100 font-light text-lg">IIUC , Kumira , Chattogram</p>
              </div>
            </div>

            {/* Phone */}
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:scale-[1.02] animate-card-float border-2 border-green-500 hover:border-green-400 group">
            ...
            {/* Email */}
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:scale-[1.02] animate-card-float border-2 border-orange-500 hover:border-orange-400 group">
              ...
              <div className="pl-12 relative z-10">
                <p className="text-amber-100 font-light text-lg">campuscraveteam@gmail.com</p>
              </div>
            </div>
