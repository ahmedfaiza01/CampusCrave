...
const AboutHome = () => {
    return (
        <div className='min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] 
    to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden'>
        ...
        items-center lg:gap-8 xl:gap-16 relative'>
                <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 
            relative'>
                    ...
                    <div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
                        <Link to='/about' className='px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-amber-500 
                        to-orange-600 rounded-xl font-bold hover:scale-[1.02] transition-transform duration-300 flex items-center gap-2 
                        sm:gap-3 shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden'>
                ...
                <div className='w-full order-2 lg"order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 
                lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500'>
                    ...
                    transition duration-500 shadow-2xl shadow-black/50'>
                        ...
                        <img src={AboutImage} alt="Restaurant" className='w-full h-auto object-cover aspect-[3/4] transform -rotate-1 
