...
const SpecialOffer = () => {
  ...
  return (
    <div className='bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white pt-4 px-4 font-["Poppins"]'>
            ...
            return (
              ...
              >
                ...
                <div className='p-6 relative z-10'>
                  <h3 className='text-2xl font-bold mb-2 bg-gradient-to-r from-amber-400 to-amber-500 bg-clip-text text-transparent font-[Playfair_Display] italic'>
                    {item.title}
                  </h3>
                  ...
                  <div className='flex items-center justify-between gap-4'>
                    ...
                    {cartItem ? (
                      ...
                      <button
                        ...
                        className='flex items-center gap-2 px-4 py-2 rounded-full bg-amber-600 hover:bg-amber-700 transition-all duration-200 text-sm font-semibold relative overflow-hidden'
                      >
                ...
                <div className=' absolute inset-0 rounded-3xl pointer-events-none border-2border-transparent group-hover:border-amber-500/30 transition-all duration-500' />
